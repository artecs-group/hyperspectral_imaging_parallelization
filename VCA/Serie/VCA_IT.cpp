...
void pinv(double * A, int n, int m)
{
	...
	LAPACKE_dgesvd(LAPACK_COL_MAJOR, 'S', 'S', n, m, A, n, S, U, LDU, VT, LDVT, superb);
	...
	cblas_dgemm(CblasColMajor, CblasTrans, CblasNoTrans, m, n, m, alpha, VT, m, Utranstmp, m, beta, A, m);
